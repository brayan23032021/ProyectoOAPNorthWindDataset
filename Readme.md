####   OLAP- MODELAMIENTO DIMENSIONAL DE LA BASE DE DATOS  NORTWIND  PARA BUSINESS INTELLIGENCE.

------------

###### Obejtivós
######1. Identificar el modelo de datos Northwind.
######2. Crear un Proyecto de ETL utilizando SQL server integration Services.

------------

##### Identificacion del modelode datos  de Northwind.

Northwind es una base de datos trasaccional  que almacena registros de ordenes de ventas que fueron solicitados en los años 1996,1997y1998  por diversos clientes con ubicacion en diversos lugares del mundo .


------------


###### Inicio del proceso - visualización del diagrama de datos.
![](https://i.ibb.co/HCn3J80/Esquema1proyecto-Northwind.jpg)

------------



###### Estructuracion del molelado de datos final  (ETL)  en la tabla dimensional.
![](https://i.ibb.co/Y2JCdNB/diagramadimensional-North.png)

------------


###### Proceso de creacion de Querys en SQL server

------------


###### Tabla Producto requerida
![](https://i.ibb.co/6bL5Sx2/Producto-REQUERIDA.png)

```SQLscript
/* Poryecto Integracion Datamart de la base de datosNorthwind 
  business intelligence */

-- Asignacion de los grrupos dependiendo el producto
select *
from [dbo].[Categories]
...
![](https://i.ibb.co/vjTmwPN/Tabla-producto.jpg)

------------


###### Tabla Empleado requerida.
![](https://i.ibb.co/Fx7jk1g/Empleadorequerida.png)
...
###### Tabla empleados Final
![](https://i.ibb.co/mv2tWmC/empleado-Final.png)
...
###### Tabla  Cliente requerida

![](https://i.ibb.co/5GF8bT8/Cliente-requerida.png)
...
-- Consulta  para la tabla clientes en el datamart
...
![](https://i.ibb.co/6gZBYPT/Cliente-vista.png)

------------


###### Tabla fecha requerida

![](https://i.ibb.co/Dktz8mP/dimencional-tiempo.png)
...
###### Tabla Tiempo Final
######"1"
![](https://i.ibb.co/tsNpgvk/Tiemposaliente1.png)

######"2"
![](https://i.ibb.co/ZB387Kj/Tiempo-Saliente2.png)

######"3"
![](https://i.ibb.co/dQWYYcz/Tiemposaliente3.png)
...
###### Tabla Ventas Requerida 
![](https://i.ibb.co/Rp0084H/Ventas-requerida.png)

```SQLscript

-- vista de tabla Ventas 
...
--- Generar la consulta de la tabla orden
...
![](https://i.ibb.co/DGmTWxN/Tablaventasfinal.png)


------------


#####Proceso de integracion  del Datamart

![](https://i.ibb.co/yX4wP79/visualstudio-Datamart1.png)

------------


##### Verificacion OK de la integracion

![](https://i.ibb.co/1rGPb6j/okverificacion.png)
